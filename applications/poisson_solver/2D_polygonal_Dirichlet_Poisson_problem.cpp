...
int main() {
	...
	cout << "调用 python 绘制解的图像" << endl;
	system("python .\\sparse_matrix_lib\\test\\plot_solution.py Poisson_small");
	...
	cout << "调用 python 绘制解的图像" << endl;
	system("python .\\sparse_matrix_lib\\test\\plot_solution.py Poisson_mid");
